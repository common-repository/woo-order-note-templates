	...
	{	
		...
		<script type="text/javascript">
			...
			jQuery( document ).ready(function() {
				jQuery('#template_category').on('change', function(e) {
					// clear data of Order note content
					jQuery('textarea#add_order_note_text').html("");
					jQuery("textarea#add_order_note_text").val("");
					...
					jQuery('#add_order_note_type').html(templateHtml);
